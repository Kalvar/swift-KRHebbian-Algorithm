...
//  Copyright (c) 2014 - 2015年 Kalvar. All rights reserved.
//

import Foundation

class KRHebbian : NSObject
{
    //學習速率 ( eta )
    var theta : Float = 1.0;
    //初始權重陣列 ( 2 維, 未轉矩陣 )
    ...
    func _sumTransposedMatrix(_transposedMatrix : [Any], _multiplicandMatrix : [Float]!) -> Float
    {
        ...
        for i in 0..<_transposedCount
        {
            ...
            for j in 0..<_multiplicandCount
            {
                ...
                //因為 _newRows 是 [Any] 型態，故這裡不可指定為 [Float]，as! 為強轉型的意思
    ...
    */
     ...
     */
    //Singleton
    class var sharedAlgorithm : KRHebbian
    {
        struct Singleton
        {
            static let instance : KRHebbian = KRHebbian();
        }
        ...
        */
        ...
        else
        {
            ...
            for var x=0; x<_xCount; x++
            {
                ...
                _transposedMatrix.append( _newRows );
            }
        }
